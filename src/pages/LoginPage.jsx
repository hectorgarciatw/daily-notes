            ...
            <div className="w-full max-w-sm p-6 rounded-lg shadow-md bg-gray-800">
                <div className="flex justify-center">
                    <a className="flex items-center space-x-2">
                        ...
                        <span className="text-2xl text-white font-semibold slogan">QuickClips</span>
                    </a>
                </div>
                ...
                <form className="mt-6">
                    ...
                    <div className="mt-6">
                        <button
                            onClick={handleLogin}
                            className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-red-500 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
                        >
                            Ingresar
                        </button>
                    </div>
